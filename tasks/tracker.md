...
- [x] 1.  Install Composer + NPM packages
- [x] 2.  Publish vendor files
- [x] 3.  Run migrations (Section 3 — all 24 migration files)
- [x] 4.  Run: php artisan db:seed
- [x] 5.  Build Traits: HasSubscriptions
- [x] 6.  Build Services: OtpService, GreenApiService, TwilioService, FcmService, SubscriptionManager
- [x] 7.  Build Services: NotificationDispatcher, AnalyticsService, SegmentService, AuditLogger, CreditService, FeatureFlagService, PasswordHistoryService
- [x] 8.  Build Middleware (all 10)
- [x] 9.  Build Custom Rule: StrongPassword
- [x] 10. Build Auth Controllers: Register, Login, OTP, Social, MagicLink, PasswordReset
- [x] 11. Build Profile Controllers: ProfileController, SessionController, DataExportController
- [x] 12. Build Billing Controllers: PlanController, StripeBillingController, InvoiceController
- [x] 13. Build Notification Controller
- [x] 14. Build Admin Controllers: AdminUserController, AdminRoleController, AdminPlanController
- [x] 15. Build Admin Controllers: SettingController, InvitationController, ActivityLogController, AnalyticsController
- [x] 16. Build Admin Controllers: BroadcastNotificationController, UserSegmentController, CouponController
- [x] 17. Build Admin Controllers: EmailTemplateController, FeatureFlagController, IpRuleController
- [x] 18. Build Admin Controllers: FailedJobController, SystemHealthController, MaintenanceController, CacheController
- [x] 19. Build Admin Controllers: RateLimitController, WebhookLogController, LogViewerController
- [x] 20. Build Admin Notification Controllers: FcmNotificationController, WhatsappNotificationController, SmsNotificationController, AdminMailController
- [x] 21. Build Webhook Controller: EmailBounceController
- [x] 22. Build Jobs: all 5 queue jobs
- [x] 23. Build Command: SendSubscriptionReminders
- [x] 24. Configure Horizon
- [x] 25. Build Mail classes (15) + Email Blade templates
- [x] 26. Build PDF template: invoice.blade.php
- [x] 27. Update bootstrap/app.php + routes/web.php + routes/console.php
- [x] 28. Update HandleInertiaRequests with all shared props
- [x] 29. Build TypeScript types: models.ts
- [x] 30. Build Frontend Components: announcement-banner, notification-bell, onboarding-checklist, notification-prompt, impersonation-bar, tos-modal, password-strength-meter, branding-header
- [x] 31. Build Auth pages: otp-verify, magic-link
- [x] 32. Build Billing pages: pricing, dashboard
